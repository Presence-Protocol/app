...
interface PaidPoapPriceInfoProps {
  isOpen: boolean;
  onClose: () => void;
  tokenName?: string;
}

export default function PaidPoapPriceInfo({ isOpen, onClose, tokenName = 'ALPH' }: PaidPoapPriceInfoProps) {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center" style={{backgroundColor: 'rgba(0,0,0,0.7)'}}>
      <div className="bg-white rounded-xl shadow p-6 w-full max-w-md border-black border-2 shadow-black">
        ...
        <p className="text-sm text-gray-500 mb-6">
          Enter the amount you wish to pay in {tokenName}. This is an open-price event where you can decide how much to contribute. The payment will be made using {tokenName} tokens, so make sure you have sufficient balance before proceeding.
        </p>
        <button
          onClick={onClose}
