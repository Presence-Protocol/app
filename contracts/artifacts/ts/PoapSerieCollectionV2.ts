...
> {
  ...
  tests = {
    ...
    setParticipatedPresence: async (
      params: TestContractParams<
        PoapSerieCollectionV2Types.Fields,
        { eventId: bigint; nftIndex: bigint },
        PoapSerieCollectionV2Types.Maps
      >
    ): Promise<TestContractResult<null, PoapSerieCollectionV2Types.Maps>> => {
      return testMethod(
...
export const PoapSerieCollectionV2 = new Factory(
  Contract.fromJson(
    ...
    "=25-2=1-1=1-2+e=2+2=1-1=2-2+a=2-2=1-3+b2=3-1+5=3-3=1-1=2-2+7b=2-2+c2=1-3+609=2-2+4c=3-1+a=1+6=2-1=2-1+a346de47154=1+50=667-1+a=475+5b27e0214706179696e67207=1+746f7261676520666565732000=240+1416=1-1+fb4b21603777e0511636f6c6c656374696f6e20706179657220092c2063616c6c657220072c2073656c662009206e6674646174612000=44+7e01076d696e74696e67=61-1+7=224+7a7e0214696e73657274206174206d617020706174683a2000=20+161416157e030b636f6c6c656374696f6e20012000=1734",
    "ce8ea0e9e0187e0da6fdf5392eb0a4fcf4b5ab70eb2b0951a23a6af4c491268a",
    AllStructs
  )
);
...
export class PoapSerieCollectionV2Instance extends ContractInstance {
  ...
  view = {
    ...
    getAmountForStorageFees: async (
      params: PoapSerieCollectionV2Types.CallMethodParams<"getAmountForStorageFees">
    ): Promise<
      PoapSerieCollectionV2Types.CallMethodResult<"getAmountForStorageFees">
    > => {
      return callMethod(
        PoapSerieCollectionV2,
        this,
  ...
  transact = {
    ...
    getAmountForStorageFees: async (
      params: PoapSerieCollectionV2Types.SignExecuteMethodParams<"getAmountForStorageFees">
    ): Promise<
      PoapSerieCollectionV2Types.SignExecuteMethodResult<"getAmountForStorageFees">
    > => {
      return signExecuteMethod(
        PoapSerieCollectionV2,
        this,
